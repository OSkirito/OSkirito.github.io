...
glm::vec3 pointlightPos = glm::vec3(-2.4f, -0.2f, -0.3f);
...
int main(int argc, char *argv[])
{
    ...
    unsigned int spotLighttex = loadTexture("./static/texture/awesomeface.png");
    
    myShader.use(); 
    myShader.setInt("material.diffusemap", 0);
    myShader.setInt("material.specularmap", 1);
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        if (ImGui::CollapsingHeader("Light Setting"), ImGuiTreeNodeFlags_DefaultOpen)
        {
            ...
            if (ImGui::CollapsingHeader("Point Light"))
            {
                ...
                ImGui::SliderFloat3("Position##Point", (float *)&pointlightPos, 0.0f, 10.0f);
        ...
        // ImGui::SameLine(); 
        // ImGui::Text("Spotlight Texture");
        // ImVec2 imageSize(100, 100); 
        // ImGui::Image((void*)(intptr_t)diffuseMap, imageSize);
        // ImGui::SameLine(); 
        // ImGui::Image((void*)(intptr_t)specularMap, imageSize);
        // ImGui::SameLine(); 
        // ImGui::Image((void*)(intptr_t)spotLighttex, imageSize);
        ImGui::End();
        ...
        glBindTexture(GL_TEXTURE_2D, spotLighttex);
        ...
        if (pointlightMove)
        {
            pointlightPos.x = pointlightPos.x + 0.008 * sin(glfwGetTime());
            pointlightPos.y = pointlightPos.y + 0.008 * cos(glfwGetTime());
        }
...
void processInput(GLFWwindow *window, float cameraSpeed)
{
    ...
    {
        cameraPos   = glm::vec3(2.0f, 1.6f, 3.3f);
